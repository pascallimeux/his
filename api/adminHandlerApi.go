...
func (a *AppContext) registerUser(w http.ResponseWriter, r *http.Request) {
	...
	userHelper, err :=  helpers.GetUserHelper(a.StatStorePath, a.AdmCrendentials, a.Authent, r)
	if err != nil {
		log.Error(err)
...
func (a *AppContext) deployCC(w http.ResponseWriter, r *http.Request) {
	...
	netHelper, err := helpers.GetNetworkHelper(a.Repo, a.StatStorePath, a.ChainID, a.AdmCrendentials, a.Authent, r)
	if err != nil {
		log.Error(err)
		utils.SendError(w, utils.ErrorInializeHelper, -1)
		return
